...
public enum Ranking {
    ...
    public static Ranking findRanking(long count, boolean hasBonusNumber) {
    ...
    private static boolean checkCountAndBonusNumber(Ranking ranking, long count, boolean hasBonusNumber) {
